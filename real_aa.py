...
from raptgen.data_aa import SingleRound
...
@click.option(
    "--fast/--normal",
    help="[experimental] use fast calculation of probability estimation. Output of the decoder shape is different and the visualizers are not implemented.",
