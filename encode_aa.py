...
from raptgen.models_aa import CNN_PHMM_VAE, CNN_PHMM_VAE_FAST
from raptgen.data_aa import SingleRound, Result
...
@click.option(
    "--fast/--normal",
    help="[experimental] use fast calculation of probability estimation. \
        Output of the decoder shape is different and the visualizers are not implemented.",
    type=bool,
    default=False
)
